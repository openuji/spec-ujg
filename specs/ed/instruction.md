...
Include State Data only for state-like data binding identity. Use Artifact, not State Data, for
files, archives, reports, invites, media, protocol objects, tokens, and other portable resources.
