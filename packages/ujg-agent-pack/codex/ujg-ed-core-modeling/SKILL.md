---
name: ujg-ed-core-modeling
description: "Generate, review, correct, and reason about Core Modeling in User Journey Graph JSON-LD for the Editor's Draft. Use when the task is scoped to Core module document containers, imports, top-level nodes, and extensions or when whole-document modeling crosses this module boundary."
---
