...
description: "Generate, review, correct, and reason about Domain Model Design in User Journey Graph JSON-LD for the Editor's Draft. Use when the task is scoped to designing the Domain Model Document Extension from UJG topology, explicit domain knowledge, or whole-document modeling across this boundary."
---
...
Scope: Domain Model Document Extension design from canonical UJG topology and optional explicit domain knowledge
