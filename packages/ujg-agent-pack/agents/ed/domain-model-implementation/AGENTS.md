...
# UJG ED Domain Model Implementation Conformance Agent Instructions

Use these instructions for software implementation conformance against a full UJG document with the Domain Model Document Extension, including domain behavior, guarded branches, effects, invariants, and journey semantics in Editor's Draft.
