...
Use these instructions for Domain Model Document Extension evaluation against Domain Requirements, UJG semantics, schema validity, traceability, minimality, assumptions, and realization neutrality in Editor's Draft.

## Skill tree context

Target: Editor's Draft
Public spec URL: https://ujg.specs.openuji.org/ed
Scope: Domain Model Document Extension evaluation against Domain Requirements, UJG semantics, schema validity, traceability, minimality, assumptions, and realization neutrality
