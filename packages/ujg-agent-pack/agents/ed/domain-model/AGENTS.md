...
# UJG ED Domain Model Design Agent Instructions

Use these instructions for Domain Model Document Extension design from canonical UJG topology and optional explicit domain knowledge in Editor's Draft.
