# UJG TR 1.0 RC1 Modeling Skill

Use this skill when generating, reviewing, correcting, or reasoning about User Journey Graph JSON-LD for the UJG 1.0 RC1 snapshot.

## Source of truth

Use the frozen UJG 1.0 RC1 snapshot unless the user explicitly asks for another version:

`https://ujg.specs.openuji.org/tr/1.0-rc1`

Treat `/tr/1.0-rc1` as frozen. Do not silently mix active ED terms with this release-candidate snapshot. Generate only terms defined by UJG 1.0 RC1 contexts unless the user explicitly requests an extension.
...
Use only UJG 1.0 RC1 Graph classes and properties.
