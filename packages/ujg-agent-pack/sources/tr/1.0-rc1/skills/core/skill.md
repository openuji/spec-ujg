...
`https://ujg.specs.openuji.org/tr/1.0-rc1/core`

Generate only terms defined by the UJG 1.0 RC1 Core context unless the user explicitly requests an extension.
